...
?>
	<main>
		<article class="artykul">
			<h3>
				<b>A więc jesteś studentem... Udowodnij! Wpisz swój numer albumu i zatwierdź.</b>
			</h3>
			<div id="panel">
				<form method="POST" action="weryfikacja.php"> 
					...
					<br>
					 <?php
						...
						//else echo "Nie jesteś studentem, kłamczuszku...";
						?> 
					<input type="submit" value="Zatwierdź" name="weryfikuj_studenta">
				</form>
			</div>
			 </br> </br> </br> </br> </br> </br> 
		</article>
