...
<html lang="pl">
<head>
    <title>Treningi personalne</title>
<meta charset="UTF-8">
...
?>
    <nav id="menuzalogowanego">
        <ul>
            <li><a href="silowniapo.php" class="text-dark">Karnety</a></li>
            <li><a href="treningipo.php" class="text-dark">Treningi personalne</a></li>
        </ul>
    </nav>
<main>
    <article class="artykul">
    <h2>Wybierz swój trening personalny! </h2>
    <table class="table table-bordered">
        ...
        <tbody>
          <?php $qry = mysqli_query($conn,"SELECT * FROM `trening` ");?>
          ...
          <tr>
            <th scope="row"><?php echo $row['nazwa']; ?></th>
             ...
             <td>
             <form action='kupywanie.php' method="post">
            <input type="hidden" name="id" value="<?php echo $row['id_treningu']; ?>">
            <input type="submit" name="Bay_trening" value="Kup">
             </form>
